...
namespace Tobii.StreamEngine
{
    public static class Interop
    {
        ...
        private static extern tobii_error_t tobii_api_create(out IntPtr api, IntPtr customAlloc,
            tobii_custom_log_t custom_log); // Custom alloc doesn't make sense in .NET
        ...
        public static tobii_error_t tobii_enumerate_local_device_urls_ex(IntPtr api, out List<string> device_urls,
            uint device_generations)
        {
            var urls = new List<string>();
            tobii_device_url_receiver_t handler = (url, data) => { urls.Add(url); };
        ...
        public static extern tobii_error_t tobii_enumerate_local_device_urls_internal(IntPtr api,
            tobii_device_url_receiver_t receiverFunction, IntPtr userData);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_enumerate_local_device_urls_ex")]
        public static extern tobii_error_t tobii_enumerate_local_device_urls_ex_internal(IntPtr api,
            tobii_device_url_receiver_t receiverFunction, IntPtr userData, uint deviceGenerations);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_device_create")]
        public static extern tobii_error_t tobii_device_create(IntPtr api, string url,
            tobii_field_of_use_t field_of_use, out IntPtr device);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_device_create_ex")]
        private static extern tobii_error_t tobii_device_create_ex_internal(IntPtr api, string url,
            tobii_field_of_use_t field_of_use, tobii_license_key_t[] license_keys, int license_count,
            [MarshalAs(UnmanagedType.LPArray)] tobii_license_validation_result_t[] licenseResults, out IntPtr device);

        public static tobii_error_t tobii_device_create_ex(IntPtr api, string url, tobii_field_of_use_t field_of_use,
            string[] license_keys, List<tobii_license_validation_result_t> license_results, out IntPtr device)
        {
            ...
            var tobii_error = tobii_device_create_ex_internal(api, url, field_of_use, keys.ToArray(), keys.Count,
                license_results_array, out device);
        ...
        public static extern tobii_error_t tobii_get_feature_group(IntPtr device,
            out tobii_feature_group_t feature_group);
        ...
        public static extern tobii_error_t tobii_get_state_bool(IntPtr device, tobii_state_t state,
            out tobii_state_bool_t value);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_state_uint32")]
        public static extern tobii_error_t tobii_get_state_uint32(IntPtr device, tobii_state_t state, out uint value);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_state_string")]
        private static extern tobii_error_t tobii_get_state_string(IntPtr device, tobii_state_t state,
            StringBuilder value);
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_notifications_subscribe")]
        public static extern tobii_error_t tobii_notifications_subscribe(IntPtr device,
            tobii_notifications_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_notifications_unsubscribe")]
        public static extern tobii_error_t tobii_notifications_unsubscribe(IntPtr device);


        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_capability_supported")]
        public static extern tobii_error_t tobii_capability_supported(IntPtr device, tobii_capability_t capability,
            out bool supported);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_stream_supported")]
        public static extern tobii_error_t tobii_stream_supported(IntPtr device, tobii_stream_t stream,
            out bool supported);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_firmware_upgrade_state")]
        public static extern tobii_error_t tobii_get_firmware_upgrade_state(IntPtr device,
            out tobii_firmware_upgrade_state_t firmware_upgrade_state);

        #region Streams

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_gaze_point_subscribe")]
        public static extern tobii_error_t tobii_gaze_point_subscribe(IntPtr device,
            tobii_gaze_point_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_gaze_point_unsubscribe")]
        public static extern tobii_error_t tobii_gaze_point_unsubscribe(IntPtr device);


        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_gaze_origin_subscribe")]
        public static extern tobii_error_t tobii_gaze_origin_subscribe(IntPtr device,
            tobii_gaze_origin_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_gaze_origin_unsubscribe")]
        public static extern tobii_error_t tobii_gaze_origin_unsubscribe(IntPtr device);


        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_eye_position_normalized_subscribe")]
        public static extern tobii_error_t tobii_eye_position_normalized_subscribe(IntPtr device,
            tobii_eye_position_normalized_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_eye_position_normalized_unsubscribe")]
        public static extern tobii_error_t tobii_eye_position_normalized_unsubscribe(IntPtr device);


        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_user_presence_subscribe")]
        public static extern tobii_error_t tobii_user_presence_subscribe(IntPtr device,
            tobii_user_presence_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_user_presence_unsubscribe")]
        public static extern tobii_error_t tobii_user_presence_unsubscribe(IntPtr device);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_head_pose_subscribe")]
        public static extern tobii_error_t tobii_head_pose_subscribe(IntPtr device, tobii_head_pose_callback_t callback,
            IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_head_pose_unsubscribe")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_update_timesync")]
        public static extern tobii_error_t tobii_update_timesync(IntPtr device);


        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_user_position_guide_subscribe")]
        public static extern tobii_error_t tobii_user_position_guide_subscribe(IntPtr device,
            tobii_user_position_guide_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_user_position_guide_unsubscribe")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode,
            EntryPoint = "tobii_wearable_consumer_data_subscribe")]
        public static extern tobii_error_t tobii_wearable_consumer_data_subscribe(IntPtr device,
            tobii_wearable_consumer_data_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode,
            EntryPoint = "tobii_wearable_consumer_data_unsubscribe")]
        public static extern tobii_error_t tobii_wearable_consumer_data_unsubscribe(IntPtr device);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode,
            EntryPoint = "tobii_wearable_advanced_data_subscribe")]
        public static extern tobii_error_t tobii_wearable_advanced_data_subscribe(IntPtr device,
            tobii_wearable_advanced_data_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode,
            EntryPoint = "tobii_wearable_advanced_data_unsubscribe")]
        public static extern tobii_error_t tobii_wearable_advanced_data_unsubscribe(IntPtr device);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_lens_configuration")]
        public static extern tobii_error_t tobii_get_lens_configuration(IntPtr device,
            out tobii_lens_configuration_t configuration);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_set_lens_configuration")]
        public static extern tobii_error_t tobii_set_lens_configuration(IntPtr device,
            ref tobii_lens_configuration_t configuration);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_lens_configuration_writable")]
        public static extern tobii_error_t tobii_lens_configuration_writable(IntPtr device,
            out tobii_lens_configuration_writable_t writable);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode,
            EntryPoint = "tobii_wearable_foveated_gaze_subscribe")]
        public static extern tobii_error_t tobii_wearable_foveated_gaze_subscribe(IntPtr device,
            tobii_wearable_foveated_gaze_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode,
            EntryPoint = "tobii_wearable_foveated_gaze_unsubscribe")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_calibration_retrieve")]
        public static extern tobii_error_t tobii_calibration_retrieve(IntPtr device, tobii_data_receiver_t callback,
            IntPtr user_data = default(IntPtr));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void tobii_calibration_point_data_receiver_t(ref tobii_calibration_point_data_t point_data,
            IntPtr user_data);

        public static tobii_error_t tobii_calibration_parse(IntPtr api, byte[] calibration,
            out List<tobii_calibration_point_data_t> point_data_items)
        {
            ...
            var result = tobii_calibration_parse(api, p, new IntPtr(calibration.Length),
                (ref tobii_calibration_point_data_t point_data, IntPtr user_data) =>
                {
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_calibration_parse")]
        public static extern tobii_error_t tobii_calibration_parse(IntPtr api, IntPtr calibration,
            IntPtr calibration_size, tobii_calibration_point_data_receiver_t callback, IntPtr user_data);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_calibration_apply")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_calculate_display_area_basic")]
        public static extern tobii_error_t tobii_calculate_display_area_basic(IntPtr api, float width_mm,
            float height_mm, float offset_x_mm, ref tobii_geometry_mounting_t geometry_mounting,
            out tobii_display_area_t display_area);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_display_area")]
        public static extern tobii_error_t tobii_get_display_area(IntPtr device, out tobii_display_area_t display_area);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_set_display_area")]
        public static extern tobii_error_t tobii_set_display_area(IntPtr device, ref tobii_display_area_t display_area);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_geometry_mounting")]
        public static extern tobii_error_t tobii_get_geometry_mounting(IntPtr device,
            out tobii_geometry_mounting_t geometry);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi,
            EntryPoint = "tobii_get_device_name")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi,
            EntryPoint = "tobii_set_device_name")]
        public static extern tobii_error_t tobii_set_device_name(IntPtr device, string device_name);


        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_enumerate_output_frequencies")]
        public static extern tobii_error_t tobii_enumerate_output_frequencies(IntPtr device,
            tobii_output_frequency_receiver_t receiver);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_set_output_frequency")]
        public static extern tobii_error_t tobii_set_output_frequency(IntPtr device, float output_frequency);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_output_frequency")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_gaze_data_subscribe")]
        public static extern tobii_error_t tobii_gaze_data_subscribe(IntPtr device, tobii_gaze_data_callback_t callback,
            IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_gaze_data_unsubscribe")]
        public static extern tobii_error_t tobii_gaze_data_unsubscribe(IntPtr device);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_enumerate_illumination_modes")]
        public static extern tobii_error_t tobii_enumerate_illumination_modes(IntPtr device,
            tobii_illumination_mode_receiver_t receiver);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_get_illumination_mode")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_set_illumination_mode")]
        ...
        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_digital_syncport_subscribe")]
        public static extern tobii_error_t tobii_digital_syncport_subscribe(IntPtr device,
            tobii_digital_syncport_callback_t callback, IntPtr user_data = default(IntPtr));

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_digital_syncport_unsubscribe")]
        public static extern tobii_error_t tobii_digital_syncport_unsubscribe(IntPtr device);

        [DllImport(stream_engine_dll, CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "tobii_enumerate_face_types")]
        private static extern tobii_error_t tobii_enumerate_face_types_internal(IntPtr device,
            tobii_face_type_receiver_t receiver, IntPtr user_data);
    ...
    {
        [MarshalAs(UnmanagedType.LPWStr)] public string license_key;
    ...
    public struct tobii_notification_value_t
    {
        ...
        [FieldOffset(0)] public tobii_state_bool_t state;
        [FieldOffset(0)] public tobii_display_area_t display_area;
        [FieldOffset(0)] public uint uint_;

        [FieldOffset(0)] public tobii_enabled_eye_t enabled_eye;
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void tobii_wearable_consumer_data_callback_t(ref tobii_wearable_consumer_data_t data,
        IntPtr user_data);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void tobii_wearable_advanced_data_callback_t(ref tobii_wearable_advanced_data_t data,
        IntPtr user_data);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void tobii_digital_syncport_callback_t(uint signal, long timestamp_tracker_us,
        long timestamp_system_us, IntPtr user_data);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void tobii_enumerated_device_receiver_t(ref tobii_enumerated_device_t enumerated_device,
        IntPtr user_data);
